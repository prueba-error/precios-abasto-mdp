...
export const Footer: React.FC = () => {
  return (
    <footer style={{ marginTop: '48px', textAlign: 'center', color: 'var(--text-secondary)', fontSize: '0.75rem', lineHeight: '1.6' }}> {/* , paddingTop: '24px', borderTop: '1px solid var(--border-color)' */}
